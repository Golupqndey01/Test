...
OWNER_ID = int(getenv("OWNER_ID", "7776174537"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/pandey_otp")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/pandey_chat")
